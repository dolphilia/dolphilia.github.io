import{_ as s,c as a,o as n,a as e}from"./app.75bfde98.js";const g=JSON.parse('{"title":"ディレクトリ構造","description":"","frontmatter":{},"headers":[{"level":3,"title":"静止画ファイル・画像","slug":"静止画ファイル・画像","link":"#静止画ファイル・画像","children":[]},{"level":3,"title":"ファイル＆フォルダの無視","slug":"ignore","link":"#ignore","children":[]},{"level":3,"title":"サブディレクトリを使ったプロジェクト統合","slug":"subdirectory","link":"#subdirectory","children":[]}],"relativePath":"translation/honkit/structure.md","lastUpdated":1676126774000}'),o={name:"translation/honkit/structure.md"},t=e(`<h1 id="ディレクトリ構造" tabindex="-1">ディレクトリ構造 <a class="header-anchor" href="#ディレクトリ構造" aria-hidden="true">#</a></h1><p>HonKitはシンプルなディレクトリ構造を使用しています。<a href="./pages">SUMMARY</a>にリストされたすべてのMarkdown/AsciidocファイルはHTMLに変換されます。多言語の書籍は若干<a href="./languages">異なる構造</a>になっています。</p><p>基本的なHonKitは通常、次のようなものです。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">.</span></span>
