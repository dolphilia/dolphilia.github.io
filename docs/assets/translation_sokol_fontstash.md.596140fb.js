import{_ as e,c as t,o,Q as n}from"./chunks/framework.44f152d8.js";const u=JSON.parse('{"title":"HOW TO","description":"","frontmatter":{},"headers":[],"relativePath":"translation/sokol/fontstash.md","lastUpdated":1676126774000}'),a={name:"translation/sokol/fontstash.md"},s=n(`<p>sokol_fontstash.h -- renderer for <a href="https://github.com/memononen/fontstash" target="_blank" rel="noreferrer">https://github.com/memononen/fontstash</a> on top of sokol_gl.h</p><p>Project URL: <a href="https://github.com/floooh/sokol" target="_blank" rel="noreferrer">https://github.com/floooh/sokol</a></p><p>Do this: #define SOKOL_IMPL or #define SOKOL_FONTSTASH_IMPL</p><p>before you include this file in <em>one</em> C or C++ file to create the implementation.</p><p>The following defines are used by the implementation to select the platform-specific embedded shader code (these are the same defines as used by sokol_gfx.h and sokol_app.h):</p><p>SOKOL_GLCORE33 SOKOL_GLES2 SOKOL_GLES3 SOKOL_D3D11 SOKOL_METAL</p><p>...optionally provide the following macros to override defaults:</p><p>SOKOL_ASSERT(c) - your own assert macro (default: assert(c)) SOKOL_FONTSTASH_API_DECL - public function declaration prefix (default: extern) SOKOL_API_DECL - same as SOKOL_FONTSTASH_API_DECL SOKOL_API_IMPL - public function implementation prefix (default: -) SOKOL_UNREACHABLE() - a guard macro for unreachable code (default: assert(false))</p><p>Include the following headers before including sokol_fontstash.h:</p><pre><code>sokol_gfx.h
...
distribution.
</code></pre>`,42),r=[s];function l(i,d,c,h,p,f){return o(),t("div",null,r)}const m=e(a,[["render",l]]);export{u as __pageData,m as default};
