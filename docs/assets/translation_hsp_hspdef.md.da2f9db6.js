import{_ as o,c as e,o as n,Q as t}from"./chunks/framework.44f152d8.js";const c=JSON.parse('{"title":"標準マクロ","description":"","frontmatter":{},"headers":[],"relativePath":"translation/hsp/hspdef.md","lastUpdated":1676126774000}'),r={name:"translation/hsp/hspdef.md"},p=t(`<h1 id="標準マクロ" tabindex="-1">標準マクロ <a class="header-anchor" href="#標準マクロ" aria-label="Permalink to &quot;標準マクロ&quot;">​</a></h1><p><strong>対応</strong>:</p><ul><li>Win</li><li>Mac</li><li>Cli</li></ul><h2 id="gmode_sub" tabindex="-1">gmode_sub <a class="header-anchor" href="#gmode_sub" aria-label="Permalink to &quot;gmode_sub {#gmode_sub}&quot;">​</a></h2><p>色減算合成コピーモード</p><p><strong>説明</strong>:</p><p>gmodeの第1引数に指定することで、画面コピーモードを色減算合成コピーモードに設定できます。</p><p><strong>例</strong>:</p><pre><code>screen 1 : picload dir_exe + &quot;/sample/demo/logop.bmp&quot;
