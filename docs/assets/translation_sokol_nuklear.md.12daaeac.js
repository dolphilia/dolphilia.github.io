...
</code></pre><p>NOTE: Unlike most other sokol-headers, the implementation must be compiled as C, compiling as C++ isn&#39;t supported. The interface is callable from C++ of course.</p><h1 id="feature-overview" tabindex="-1">FEATURE OVERVIEW: <a class="header-anchor" href="#feature-overview" aria-hidden="true">#</a></h1><p>sokol_nuklear.h implements the initialization, rendering and event-handling code for Nuklear (<a href="https://github.com/Immediate-Mode-UI/Nuklear" target="_blank" rel="noreferrer">https://github.com/Immediate-Mode-UI/Nuklear</a>) on top of sokol_gfx.h and (optionally) sokol_app.h.</p><p>The sokol_app.h dependency is optional and used for input event handling. If you only use sokol_gfx.h but not sokol_app.h in your application, define SOKOL_NUKLEAR_NO_SOKOL_APP before including the implementation of sokol_nuklear.h, this will remove any dependency to sokol_app.h, but you must feed input events into Nuklear yourself.</p><p>sokol_nuklear.h is not thread-safe, all calls must be made from the same thread where sokol_gfx.h is running.</p><h1 id="howto" tabindex="-1">HOWTO: <a class="header-anchor" href="#howto" aria-hidden="true">#</a></h1><p>--- To initialize sokol-nuklear, call:</p><pre><code>snk_setup(const snk_desc_t* desc)
...
</code></pre><p>--- Note that for touch-based systems, like iOS, there is a wrapper around nk_edit_string(...), called snk_edit_string(...) which will show and hide the onscreen keyboard as required.</p><h1 id="license" tabindex="-1">LICENSE <a class="header-anchor" href="#license" aria-hidden="true">#</a></h1><p>zlib/libpng license</p><p>Copyright (c) 2020 Warren Merrifield</p><p>This software is provided &#39;as-is&#39;, without any express or implied warranty. In no event will the authors be held liable for any damages arising from the use of this software.</p><p>Permission is granted to anyone to use this software for any purpose, including commercial applications, and to alter it and redistribute it freely, subject to the following restrictions:</p><pre><code>1. The origin of this software must not be misrepresented; you must not
...
distribution.
</code></pre>`,40),i=[r];function s(l,d,p,h,c,u){return t(),n("div",null,i)}const m=e(a,[["render",s]]);export{_ as __pageData,m as default};
