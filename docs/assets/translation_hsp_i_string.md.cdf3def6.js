...
p1=文字列 : 取り出す元の文字列
p2=0〜    : 情報のタイプ指定
</code></pre><p><strong>説明</strong>:</p><p>p1で指定したファイルパスを示す文字列をp2で指定したタイプの情報に変換したものを文字列として返します。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	&quot;test&quot;となる</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">例 :</span></span>
...
&quot;format&quot; : 書式指定文字列
p1       : 書式指定パラメーター
</code></pre><p><strong>説明</strong>:</p><p>整数または実数値を適切な書式で文字列に変換した文字列を返します。 &quot;format&quot;で、以下のような書式指定文字列を指定します。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	mes strf(&quot;10進実数桁数指定付き[%3.10f]&quot;,a)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">例 :</span></span>
...
p2=0〜3(0) : 除去する位置の指定
p3=0〜65535(32) : 文字コード
</code></pre><p><strong>説明</strong>:</p><p>p1で指定した変数に格納されている文字列の中から指定した文字だけを取り除きます。 p2で、除去する位置の指定を行なうことができます。 p2が省略された場合は、文字列の両端が指定文字だった場合のみ除去されます。 p3で除去する文字コードを指定することができます。 p3が省略された場合は、半角スペース(32)となります。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	mes b</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">     3    : 文字列内にあるすべての指定文字を除去する</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">タイプ : 内容</span></span>
<span class="line"><span style="color:#24292e;"> -----------------------------------------------------------</span></span>
...
<span class="line"><span style="color:#24292e;">     3    : 文字列内にあるすべての指定文字を除去する</span></span></code></pre></div><p>p3で指定する文字コードには、全角文字を示す2バイトコードを指定することができます。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	mes strtrim(s,3,code)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	mes b</span></span>
<span class="line"><span style="color:#e1e4e8;">	mes c</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">例 :</span></span>
...
<span class="line"><span style="color:#24292e;">	mes b</span></span>
<span class="line"><span style="color:#24292e;">	mes c</span></span></code></pre></div><p>指定された変数の数よりも、もともとの要素の数が少ない場合は、残りの変数に空の文字列(&quot;&quot;)が代入されます。 指定された変数の数よりも、分割された要素が多い場合は、指定された変数の配列に代入されていきます。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">例 :</span></span>
...
<span class="line"><span style="color:#e1e4e8;">	loop</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">例 :</span></span>
...
&quot;string&quot; : 検索する文字列
p1(0)    : 検索モード
</code></pre><p><strong>説明</strong>:</p><p>現在対象となっているメモリノートパッドの中から、特定の文字列を含む行を検索します。 p1で検索モードを指定します。それぞれのモードに対応したマクロが定義されています。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">モード : マクロ            内容</span></span>
<span class="line"><span style="color:#e1e4e8;"> -----------------------------------------------------------</span></span>
...
<span class="line"><span style="color:#e1e4e8;">      2   : notefind_instr    &quot;string&quot;を含む行を検索</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">モード : マクロ            内容</span></span>
<span class="line"><span style="color:#24292e;"> -----------------------------------------------------------</span></span>
