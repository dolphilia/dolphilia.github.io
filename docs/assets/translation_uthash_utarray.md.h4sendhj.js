...
<span class="line"><span>BSD licensed</span></span></code></pre></div><p>This software is made available under the link:license.html[revised BSD license]. It is free and open source.</p><p>Platforms</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>The &#39;utarray&#39; macros have been tested on:</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>-----</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Declaration</span></span></code></pre></div><p>The array itself has the data type <code>UT_array</code>, regardless of the type of elements to be stored in it. It is declared like,</p><p>UT_array *nums;</p><p>New and free</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>The next step is to create the array using \`utarray_new\`. Later when you&#39;re</span></span>
<span class="line"><span>done with the array, \`utarray_free\` will free it and all its elements.</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Push, pop, etc</span></span></code></pre></div><p>The central features of the utarray involve putting elements into it, taking them out, and iterating over them. There are several &lt;&lt;operations,operations&gt;&gt; to pick from that deal with either single elements or ranges of elements at a time. In the examples below we will use only the push operation to insert elements.</p><h2 id="elements" tabindex="-1">Elements <a class="header-anchor" href="#elements" aria-label="Permalink to &quot;Elements&quot;">​</a></h2><p>Support for dynamic arrays of integers or strings is especially easy. These are best shown by example:</p><p>Integers</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>This example makes a utarray of integers, pushes 0-9 into it, then prints it.</span></span>
...
<span class="line"><span>  #include &quot;utarray.h&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// vim: set nowrap syntax=asciidoc:</span></span></code></pre></div>`,32),l=[t];function i(r,c,o,u,d,h){return n(),s("div",null,l)}const _=a(e,[["render",i]]);export{m as __pageData,_ as default};
