import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.92ce8a2a.js";const w=JSON.parse('{"title":"GLFWドキュメンテーション","description":"","frontmatter":{},"headers":[],"relativePath":"translation/GLFW/index.md","filePath":"translation/GLFW/index.md","lastUpdated":1676126774000}'),p={name:"translation/GLFW/index.md"},o=l(`<h1 id="glfwドキュメンテーション" tabindex="-1">GLFWドキュメンテーション <a class="header-anchor" href="#glfwドキュメンテーション" aria-label="Permalink to &quot;GLFWドキュメンテーション&quot;">​</a></h1><div class="info custom-block"><p class="custom-block-title">INFO</p><p>このページおよび同じカテゴリーにあるすべてのページは<a href="https://www.glfw.org" target="_blank" rel="noreferrer">GLFW公式サイト</a>のドキュメントを日本語に翻訳したものです。</p></div><p>HTMLドキュメントにはチュートリアル・トピック別のガイド・APIリファレンスが含まれています。</p><p>FAQはGLFWの設計・実装・使用に関する多くの一般的な質問に答えています。</p><nav class="table-of-contents"><ul><li><a href="#ライセンス">ライセンス</a></li><li><a href="#コード例">コード例</a></li></ul></nav><h2 id="ライセンス" tabindex="-1">ライセンス <a class="header-anchor" href="#ライセンス" aria-label="Permalink to &quot;ライセンス&quot;">​</a></h2><p>GLFWはzlib/libpngライセンスに基づき改変・配布・クローズドソースソフトウェアでの利用を許可しています。</p><h2 id="コード例" tabindex="-1">コード例 <a class="header-anchor" href="#コード例" aria-label="Permalink to &quot;コード例&quot;">​</a></h2><p>以下は、GLFWでウィンドウとOpenGLコンテキストをセットアップする短い例です。ここで使われている以外にも多くの関数があります。GLFWの簡単な紹介はHTMLドキュメントのGetting startedを参照してください。</p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">#include</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&lt;GLFW/glfw3.h&gt;</span></span>
