import{_ as s,o as p,c as n,U as a}from"./chunks/framework.a0f12ab5.js";const u=JSON.parse('{"title":"画面制御","description":"","frontmatter":{},"headers":[],"relativePath":"translation/hsp/i_graph.md","filePath":"translation/hsp/i_graph.md","lastUpdated":1676126774000}'),o={name:"translation/hsp/i_graph.md"},l=a(`<h1 id="画面制御" tabindex="-1">画面制御 <a class="header-anchor" href="#画面制御" aria-label="Permalink to &quot;画面制御&quot;">​</a></h1><p><strong>対応</strong>:</p><ul><li>Win</li></ul><h2 id="cls" tabindex="-1">cls <a class="header-anchor" href="#cls" aria-label="Permalink to &quot;cls {#cls}&quot;">​</a></h2><p>画面クリア</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1
 p1=0〜4(0) : クリアする時の色
</code></pre><p><strong>説明</strong>:</p><p>ウィンドウ内の情報をすべてクリアします。</p><p>p1でクリアする５種類の色を指定することができます。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">色の指定値 :</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	stop</span></span></code></pre></div><p>ファイル選択が完了すると、その結果がシステム変数statに代入されます。 変数statが1ならば、正常に選択されたことを意味します。変数statが0ならば、キャンセルされたかエラーが発生したことを意味しています。 「|」記号により区切ることで複数のファイル種別を指定することが可能です。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">例 :</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  stat=2 : 解像度の変更ができなかった。</span></span></code></pre></div><h2 id="color" tabindex="-1">color <a class="header-anchor" href="#color" aria-label="Permalink to &quot;color {#color}&quot;">​</a></h2><p>カラー設定</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3
...
</code></pre><p><strong>説明</strong>:</p><p>gcopyで使用されるモードおよび、サイズ、ブレンド率などを設定します。 それぞれのコピーモード動作は以下の通りです。</p><p>・モード0 = 通常のコピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">WindowsのシステムAPI(BitBlt関数)を使った画像コピーを行ないます。</span></span>
<span class="line"><span style="color:#A6ACCD;">最も標準的なモードです。</span></span>
<span class="line"><span style="color:#A6ACCD;">多くの場合、他のモードよりも高速に処理されます。</span></span></code></pre></div><p>・モード1 = メモリ間コピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">画像バッファ間のメモリコピーを行ないます。</span></span>
<span class="line"><span style="color:#A6ACCD;">コピー元とコピー先は、同じ画像モード(パレットモード・フルカラーモード)でなければなりません。</span></span>
<span class="line"><span style="color:#A6ACCD;">動作は モード0と同じですが、非常に小さいサイズ(16*16ドット以下等)のコピーを行った際 モード0よりも 若干 高速になる場合があります。</span></span></code></pre></div><p>・モード2 = 透明色付きコピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">モード1と同様の方法でコピーを行ないますが、 RGBがすべて0(完全な黒)のドットは透明色とみなされコピーされません。</span></span></code></pre></div><p>・モード3 = 半透明合成コピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">フルカラーモード時のみ使用することができます。</span></span>
...
<span class="line"><span style="color:#A6ACCD;">ブレンド率が0の場合はコピーは実行されません。</span></span></code></pre></div><p>・モード5 = 色加算合成コピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">フルカラーモード時のみ使用することができます。</span></span>
...
<span class="line"><span style="color:#A6ACCD;">加算時に輝度が255を越える場合は、255にクランプされます。</span></span></code></pre></div><p>・モード6 = 色減算合成コピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">フルカラーモード時のみ使用することができます。</span></span>
<span class="line"><span style="color:#A6ACCD;">gmodeの4番目のパラメーターで指定したブレンド率による色減算合成コピーを行ないます。色減算では、コピー先のRGB値から、コピー元のRGB値を減算します。減算時に輝度が0を下回る場合は、0にクランプされます。</span></span></code></pre></div><p>・モード7 = ピクセルアルファブレンドコピー</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">フルカラーモード時のみ使用することができます。</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	goto *main_loop</span></span></code></pre></div><h2 id="screen" tabindex="-1">screen <a class="header-anchor" href="#screen" aria-label="Permalink to &quot;screen {#screen}&quot;">​</a></h2><p>ウィンドウを初期化</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3,p4,p5,p6,p7,p8
 p1=0〜(0)  : ウィンドウID
 p2=1〜(640): 初期化する画面サイズX（1ドット単位）
 p3=1〜(480): 初期化する画面サイズY（1ドット単位）
 p4=0〜(0)  : 初期化する画面モード
...
<span class="line"><span style="color:#A6ACCD;">	screen 0,640,480,1</span></span></code></pre></div><p>上の例では、ウィンドウID0、つまりメインウィンドウを640x480ドット、パレットモードで再初期化します。</p><p>p5,p6パラメーターにより、デスクトップ画面上に表示されるウィンドウの位置を指定することができます。 p5,p6を省略またはマイナス値にした場合は、システム規定の座標が使用されます。 p2,p3パラメーターで指定された画面サイズの一部だけをウィンドウに表示したい場合には、 p7,p8のパラメータで、ウィンドウのクライアントサイズ(実際に表示される大きさ)を指定することができます。 その場合は、groll命令によりウィンドウ内に表示される位置を設定することができるようになります。 通常は、p7,p8パラメーターの指定は省略して構いません。その場合は、p2,p3で指定された画面サイズと同じクライアントサイズで表示します。</p><p>screen命令で画面を初期化した後はそのウィンドウIDが画面制御命令の描画先になります。</p><p><strong>参照</strong>:</p><p>bgscr buffer groll screen_fixedsize screen_frame screen_hide screen_normal screen_palette screen_tool</p><p><strong>追加対応</strong>:</p><ul><li>Let</li></ul><p><strong>対応の補足</strong>:</p><p>HSPLet時、パレットモード・ツールウィンドウ・深い淵のあるウィンドウは使用できません。</p><h2 id="width" tabindex="-1">width <a class="header-anchor" href="#width" aria-label="Permalink to &quot;width {#width}&quot;">​</a></h2><p>ウィンドウサイズ設定</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3,p4
 ...
 p1=0〜 : フォント種類指定
</code></pre><p><strong>説明</strong>:</p><p>システム標準のフォントを選択します。 p1で、フォントの種類を指定します。これは以下の中から選びます。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">p1 : font set</span></span>
<span class="line"><span style="color:#A6ACCD;"> --------------------------------------------------------------------</span></span>
...
</code></pre><p><strong>説明</strong>:</p><p>p1で指定したシステムカラーインデックスを選択色として設定します。 (color命令で指定したのと同じ状態になります) p1で指定できるシステムカラーインデックスは、以下の値となります。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">0 : スクロールバーの軸の色</span></span>
...
<span class="line"><span style="color:#A6ACCD;">30 : (Windows XP以上) メニューがフラットメニューとして表示されるときのメニューバーの背景色</span></span></code></pre></div><p><strong>参照</strong>:</p><p>color palcolor hsvcolor</p><p><strong>追加対応</strong>:</p><ul><li>Let</li></ul><h2 id="hsvcolor" tabindex="-1">hsvcolor <a class="header-anchor" href="#hsvcolor" aria-label="Permalink to &quot;hsvcolor {#hsvcolor}&quot;">​</a></h2><p>HSV形式でカラーを設定する</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3
 ...
 p1=0〜 : 取得するタイプ
</code></pre><p><strong>説明</strong>:</p><p>p1で指定したタイプのウィンドウ関連情報値を返します。 取得できるタイプは以下の通りです。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">0 : スクリーン上のマウスカーソルX座標</span></span>
...
</code></pre><p><strong>説明</strong>:</p><p>(p1,p2)を左上の点として、(p3,p4)のサイズをグラデーションで矩形(四角形)を塗りつぶします。 塗りつぶす色は、p6,p7で指定されたRGBカラーコードとなります。 RGBカラーコードは、color命令で指定するR,G,Bそれぞれの輝度をまとめて24ビット数値で表現したものです。 スクリプトで記述する場合は、最初に「$」を付けた16進表現を行なうと便利です。 「$112233」のように記述した場合は、R輝度が$11、G輝度が$22、B輝度が$33という値になります。この場合、輝度は00〜ffまでとなります。(10進数の0〜255にあたります) p5でグラデーションのモードを指定することができます。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">p5 : グラデーションのモード</span></span>
<span class="line"><span style="color:#A6ACCD;"> --------------------------------------------------------------------</span></span>
