...
</code></pre><p>Here the index for &quot;01&quot; is 5, which causes a test case failure.</p>`,89),c=e("h3",{id:"ch15-15-9-15-9-3-s15-9-3-1-a5",tabindex:"-1"},[t("ch15/15.9/15.9.3/"),e("a",{href:"./","T1,T2,T3,T4,T5,T6":""},"S15.9.3.1_A5"),t(),e("a",{class:"header-anchor",href:"#ch15-15-9-15-9-3-s15-9-3-1-a5","aria-label":'Permalink to "ch15/15.9/15.9.3/[S15.9.3.1_A5](){T1,T2,T3,T4,T5,T6}"'},"​")],-1),d=a(`<p>These tests fail with:</p><pre><code>=== ch15/15.9/15.9.3/S15.9.3.1_A5_T1 failed in non-strict mode ===
--- errors ---
