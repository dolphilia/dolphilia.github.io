import{_ as e,c as i,o as n,a as o}from"./app.75bfde98.js";const g=JSON.parse('{"title":"STEP BY STEP:","description":"","frontmatter":{},"headers":[],"relativePath":"translation/sokol/gfx_imgui.md","lastUpdated":1676126774000}'),t={name:"translation/sokol/gfx_imgui.md"},a=o(`<p>sokol_gfx_imgui.h -- debug-inspection UI for sokol_gfx.h using Dear ImGui</p><p>Project URL: <a href="https://github.com/floooh/sokol" target="_blank" rel="noreferrer">https://github.com/floooh/sokol</a></p><p>Do this: #define SOKOL_IMPL or #define SOKOL_GFX_IMGUI_IMPL</p><p>before you include this file in <em>one</em> C or C++ file to create the implementation.</p><p>NOTE that the implementation can be compiled either as C++ or as C. When compiled as C++, sokol_gfx_imgui.h will directly call into the Dear ImGui C++ API. When compiled as C, sokol_gfx_imgui.h will call cimgui.h functions instead.</p><p>Include the following file(s) before including sokol_gfx_imgui.h:</p><pre><code>sokol_gfx.h
