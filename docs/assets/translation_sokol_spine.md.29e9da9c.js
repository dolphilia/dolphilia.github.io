...
</code></pre><p>This returns the current number of recorded vertices, indices and draw commands.</p><h1 id="resource-states" tabindex="-1">RESOURCE STATES: <a class="header-anchor" href="#resource-states" aria-hidden="true">#</a></h1><p>Similar to sokol-gfx, you can query the current &#39;resource state&#39; of Spine objects:</p><pre><code>sspine_resource_state sspine_get_atlas_resource_state(sspine_atlas atlas);
...
</code></pre><h1 id="animations" tabindex="-1">ANIMATIONS <a class="header-anchor" href="#animations" aria-hidden="true">#</a></h1><p>Animations have their own handle type sspine_anim. A valid sspine_anim handle is either obtained by looking up an animation by name from a skeleton:</p><pre><code>sspine_anim anim = sspine_anim_by_name(skeleton, &quot;walk&quot;);
...
</code></pre><h1 id="bones" tabindex="-1">BONES <a class="header-anchor" href="#bones" aria-hidden="true">#</a></h1><p>Skeleton bones are wrapped with an sspine_bone handle which can be created from a skeleton handle, and either a bone name:</p><pre><code>sspine_bone bone = sspine_bone_by_name(skeleton, &quot;root&quot;);
...
...
</code></pre><p>If no overrides are provided, malloc and free will be used.</p><p>This only affects memory allocation calls done by sokol_gfx.h itself though, not any allocations in OS libraries.</p><h1 id="license" tabindex="-1">LICENSE <a class="header-anchor" href="#license" aria-hidden="true">#</a></h1><p>zlib/libpng license</p><p>Copyright (c) 2022 Andre Weissflog</p><p>This software is provided &#39;as-is&#39;, without any express or implied warranty. In no event will the authors be held liable for any damages arising from the use of this software.</p><p>Permission is granted to anyone to use this software for any purpose, including commercial applications, and to alter it and redistribute it freely, subject to the following restrictions:</p><pre><code>1. The origin of this software must not be misrepresented; you must not
