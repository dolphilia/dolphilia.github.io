import{_ as s,o as n,c as t,R as p}from"./chunks/framework.320df067.js";const A=JSON.parse('{"title":"文字列","description":"","frontmatter":{},"headers":[],"relativePath":"translation/hsp/i_string.md","filePath":"translation/hsp/i_string.md","lastUpdated":1676126774000}'),a={name:"translation/hsp/i_string.md"},o=p(`<h1 id="文字列" tabindex="-1">文字列 <a class="header-anchor" href="#文字列" aria-label="Permalink to &quot;文字列&quot;">​</a></h1><p><strong>対応</strong>:</p><ul><li>Win</li><li>Cli</li><li>Let</li></ul><h2 id="getstr" tabindex="-1">getstr <a class="header-anchor" href="#getstr" aria-label="Permalink to &quot;getstr {#getstr}&quot;">​</a></h2><p>バッファから文字列読み出し</p><p><strong>グループ</strong>:</p><p>文字列操作命令</p><p><strong>パラメーター</strong>:</p><pre><code>p1,p2,p3,p4,p5
p1=変数   : 内容を読み出す先の変数名
p2=変数   : バッファを割り当てた変数名
...
p1=文字列 : 取り出す元の文字列
p2=0〜    : 情報のタイプ指定
</code></pre><p><strong>説明</strong>:</p><p>p1で指定したファイルパスを示す文字列をp2で指定したタイプの情報に変換したものを文字列として返します。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">例 :</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	&quot;test&quot;となる</span></span></code></pre></div><p>タイプ指定の詳細は以下の通りです。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">タイプ : 内容</span></span>
<span class="line"><span style="color:#A6ACCD;"> -----------------------------------------------------------</span></span>
...
&quot;format&quot; : 書式指定文字列
p1       : 書式指定パラメーター
</code></pre><p><strong>説明</strong>:</p><p>整数または実数値を適切な書式で文字列に変換した文字列を返します。 &quot;format&quot;で、以下のような書式指定文字列を指定します。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">例 :</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	mes strf(&quot;[%03d] [%f] [%s]&quot;,a,b,c)</span></span></code></pre></div><p>書式指定文字列は、Cランタイムライブラリがサポートしているsprintfの書式とほぼ同様です。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">%[width][.precision][I64]type</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">	type  : 入力されるパラメーターの型</span></span></code></pre></div><p>のような形式となり、[]内の記述は省略することが可能です。 typeで指定可能な文字は以下の通りです。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">文字           内容</span></span>
<span class="line"><span style="color:#A6ACCD;">	---------------------------------------------</span></span>
...
<span class="line"><span style="color:#A6ACCD;">	mes b</span></span></code></pre></div><p>p2で指定する、除去位置を示す値の詳細は以下の通りです。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">タイプ : 内容</span></span>
<span class="line"><span style="color:#A6ACCD;"> -----------------------------------------------------------</span></span>
...
<span class="line"><span style="color:#A6ACCD;">     3    : 文字列内にあるすべての指定文字を除去する</span></span></code></pre></div><p>p3で指定する文字コードには、全角文字を示す2バイトコードを指定することができます。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">例 :</span></span>
...
&quot;string&quot; : 検索する文字列
p1(0)    : 検索モード
</code></pre><p><strong>説明</strong>:</p><p>現在対象となっているメモリノートパッドの中から、特定の文字列を含む行を検索します。 p1で検索モードを指定します。それぞれのモードに対応したマクロが定義されています。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">モード : マクロ            内容</span></span>
<span class="line"><span style="color:#A6ACCD;"> -----------------------------------------------------------</span></span>
