...
<span class="line"><span>-----</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Declaration</span></span></code></pre></div><p>The ring-buffer itself has the data type <code>UT_ringbuffer</code>, regardless of the type of elements to be stored in it. It is declared like,</p><p>UT_ringbuffer *history;</p><p>New and free</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>The next step is to create the ring-buffer using \`utringbuffer_new\`. Later when you&#39;re</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>// vim: set nowrap syntax=asciidoc:</span></span></code></pre></div>`,28),t=[i];function l(r,c,o,u,f,d){return s(),a("div",null,t)}const b=n(p,[["render",l]]);export{g as __pageData,b as default};
