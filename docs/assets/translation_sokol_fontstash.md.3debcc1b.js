...
</code></pre><h1 id="how-to" tabindex="-1">HOW TO <a class="header-anchor" href="#how-to" aria-hidden="true">#</a></h1><p>--- First initialize sokol-gfx and sokol-gl as usual:</p><pre><code>    sg_setup(&amp;(sg_desc){...});
    sgl_setup(&amp;(sgl_desc){...});
...
...
</code></pre><p>If no overrides are provided, malloc and free will be used. Please note that this doesn&#39;t affect any memory allocation performed in fontstash.h (unfortunately those are hardwired to malloc/free).</p><h1 id="license" tabindex="-1">LICENSE <a class="header-anchor" href="#license" aria-hidden="true">#</a></h1><p>zlib/libpng license</p><p>Copyright (c) 2018 Andre Weissflog</p><p>This software is provided &#39;as-is&#39;, without any express or implied warranty. In no event will the authors be held liable for any damages arising from the use of this software.</p><p>Permission is granted to anyone to use this software for any purpose, including commercial applications, and to alter it and redistribute it freely, subject to the following restrictions:</p><pre><code>1. The origin of this software must not be misrepresented; you must not
...
distribution.
</code></pre>`,42),r=[s];function l(i,d,c,h,p,f){return o(),t("div",null,r)}const g=e(a,[["render",l]]);export{u as __pageData,g as default};
