import{_ as s,c as n,o as p,Q as t}from"./chunks/framework.44f152d8.js";const A=JSON.parse('{"title":"文字列","description":"","frontmatter":{},"headers":[],"relativePath":"translation/hsp/i_string.md","lastUpdated":1676126774000}'),a={name:"translation/hsp/i_string.md"},o=t(`<h1 id="文字列" tabindex="-1">文字列 <a class="header-anchor" href="#文字列" aria-label="Permalink to &quot;文字列&quot;">​</a></h1><p><strong>対応</strong>:</p><ul><li>Win</li><li>Cli</li><li>Let</li></ul><h2 id="getstr" tabindex="-1">getstr <a class="header-anchor" href="#getstr" aria-label="Permalink to &quot;getstr {#getstr}&quot;">​</a></h2><p>バッファから文字列読み出し</p><p><strong>グループ</strong>:</p><p>文字列操作命令</p><p><strong>パラメーター</strong>:</p><pre><code>p1,p2,p3,p4,p5
p1=変数   : 内容を読み出す先の変数名
p2=変数   : バッファを割り当てた変数名
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>タイプ値は、合計することで複数指定を行なうことが可能です。 タイプ16が指定された場合は、すべての英文字列を小文字に変換します。</p><p><strong>参照</strong>:</p><p>getstr instr</p><h2 id="strf" tabindex="-1">strf <a class="header-anchor" href="#strf" aria-label="Permalink to &quot;strf {#strf}&quot;">​</a></h2><p>書式付き文字列を変換</p><p><strong>グループ</strong>:</p><p>文字列操作関数</p><p><strong>パラメーター</strong>:</p><pre><code>(&quot;format&quot;,p1...)
&quot;format&quot; : 書式指定文字列
p1       : 書式指定パラメーター
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>書式指定文字列は、1023文字までの文字列のみ認識されますので注意してください。</p><p><strong>参照</strong>:</p><p>mes print</p><h2 id="cnvwtos" tabindex="-1">cnvwtos <a class="header-anchor" href="#cnvwtos" aria-label="Permalink to &quot;cnvwtos {#cnvwtos}&quot;">​</a></h2><p>unicodeを通常文字列に変換</p><p><strong>グループ</strong>:</p><p>文字列操作関数</p><p><strong>パラメーター</strong>:</p><pre><code>(p1)
p1=変数 : 内容を読み出す元の変数名
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>実行後に、システム変数statに分割できた数が代入されます。</p><p><strong>参照</strong>:</p><p>getstr csvnote</p><p><strong>非対応</strong>:</p><ul><li>Let</li></ul><h2 id="strrep" tabindex="-1">strrep <a class="header-anchor" href="#strrep" aria-label="Permalink to &quot;strrep {#strrep}&quot;">​</a></h2><p>文字列の置換をする</p><p><strong>グループ</strong>:</p><p>文字列操作命令</p><p><strong>パラメーター</strong>:</p><pre><code>p1,&quot;検索文字列&quot;,&quot;置換文字列&quot;
p1=変数名 : 検索される文字列が格納されている文字列型変数名
&quot;検索文字列&quot; : 検索する文字列
&quot;置換文字列&quot; : 置換する文字列
