...
<span class="line"><span></span></span>
<span class="line"><span>私の答えは、彼らは一文字を変更することで二次的著作物を作成し、それを好きなようにライセンスすることができる、というものです。(実際、zlibやBSDのライセンスを*追加することは、そのような変更になります!) 残念ながら、彼らの弁護士はこの答えを好まなかったと言われています :(</span></span></code></pre></div>`,11),i=[e];function t(c,o,_,r,d,h){return n(),a("div",null,i)}const u=s(l,[["render",t]]);export{b as __pageData,u as default};
