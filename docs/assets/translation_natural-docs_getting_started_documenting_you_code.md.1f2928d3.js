import{_ as s,c as n,o as a,a as l}from"./app.1650bd79.js";const D=JSON.parse('{"title":"Natural Docsによるコードの文書化（日本語訳）","description":"","frontmatter":{},"headers":[{"level":2,"title":"基本","slug":"基本","link":"#基本","children":[]},{"level":2,"title":"クラスと範囲","slug":"クラスと範囲","link":"#クラスと範囲","children":[{"level":3,"title":"対象範囲","slug":"対象範囲","link":"#対象範囲","children":[]}]},{"level":2,"title":"その他の書式","slug":"その他の書式","link":"#その他の書式","children":[{"level":3,"title":"段落、太字、下線","slug":"段落、太字、下線","link":"#段落、太字、下線","children":[]},{"level":3,"title":"箇条書きリスト","slug":"箇条書きリスト","link":"#箇条書きリスト","children":[]},{"level":3,"title":"定義リスト","slug":"定義リスト","link":"#定義リスト","children":[]},{"level":3,"title":"コードとテキスト図","slug":"コードとテキスト図","link":"#コードとテキスト図","children":[]}]},{"level":2,"title":"リンクの詳細","slug":"リンクの詳細","link":"#リンクの詳細","children":[{"level":3,"title":"複数形と所有格","slug":"複数形と所有格","link":"#複数形と所有格","children":[]}]},{"level":2,"title":"追加ドキュメント","slug":"追加ドキュメント","link":"#追加ドキュメント","children":[{"level":3,"title":"単体でのコメント","slug":"単体でのコメント","link":"#単体でのコメント","children":[]},{"level":3,"title":"テキストファイル","slug":"テキストファイル","link":"#テキストファイル","children":[]}]},{"level":2,"title":"リストの文書化","slug":"リストの文書化","link":"#リストの文書化","children":[]}],"relativePath":"translation/natural-docs/getting_started/documenting_you_code.md","lastUpdated":1676126774000}'),p={name:"translation/natural-docs/getting_started/documenting_you_code.md"},e=l(`<h1 id="natural-docsによるコードの文書化-日本語訳" tabindex="-1">Natural Docsによるコードの文書化（日本語訳） <a class="header-anchor" href="#natural-docsによるコードの文書化-日本語訳" aria-hidden="true">#</a></h1><p><a href="https://www.naturaldocs.org/getting_started/documenting_your_code/" target="_blank" rel="noreferrer">原文</a></p><h2 id="基本" tabindex="-1">基本 <a class="header-anchor" href="#基本" aria-hidden="true">#</a></h2><p>いよいよコードの文書化を開始するときが来ました。文書化を非常に簡単かつ苦痛にならないようにするため、すぐに飛び込んでみましょう。</p><div class="language-c"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// Function: Multiply</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>生成されたドキュメントのいたるところでこのようなことが書かれていますね。</p><h2 id="クラスと範囲" tabindex="-1">クラスと範囲 <a class="header-anchor" href="#クラスと範囲" aria-hidden="true">#</a></h2><p>しかし、有用性に疑問のあるクラス全体がある場合はどうでしょうか。各要素のすぐ上にNatural Docsのコメントを付けて個々の関数をドキュメント化したのと同じように、クラスとそのメンバーをドキュメント化することができます。この例では管理しやすいように短い説明文に戻します。</p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// Class: Counter</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>複数の単語に下線を引く場合、それぞれのスペースにアンダースコアを使うこともできますし、上記のように端につけることもできます。どちらの方法も有効です。</p><h3 id="箇条書きリスト" tabindex="-1">箇条書きリスト <a class="header-anchor" href="#箇条書きリスト" aria-hidden="true">#</a></h3><p>行頭にダッシュやアスタリスクを付けると、箇条書きにすることができます。内容は複数行にまたがることがあるので、終わらせるには1行飛ばす必要があります。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">- Bullet one.</span></span>
...
<span class="line"><span style="color:#A6ACCD;">Level two, second paragraph.</span></span>
<span class="line"><span style="color:#A6ACCD;">Level three.</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="定義リスト" tabindex="-1">定義リスト <a class="header-anchor" href="#定義リスト" aria-hidden="true">#</a></h3><p>定義リストは「項目 - 定義」という形式の行です。箇条書きのリストと同様、行を飛ばすまで続き、インデントされていれば定義の中に複数の段落を持つことができます。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Item 1 - The first paragraph.</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Counterのような文書化されたタイプの場合、その定義へのリンクとなり、マウスを乗せると概要がポップアップ表示されます。</p><h3 id="コードとテキスト図" tabindex="-1">コードとテキスト図 <a class="header-anchor" href="#コードとテキスト図" aria-hidden="true">#</a></h3><p>コードのセクションを追加するには、少なくとも3つのダッシュ・等号・またはアンダースコアで行を開始し、「Code」を続けてください。同じ記号が3つ以上並ぶ別の行が現れるまで続けられます。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">This is a normal paragraph.</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>電子メールアドレスは、見た目は通常のリンクと同じですが、HTMLが難読化されており、スパム・クローラーから保護することができます。</p><h3 id="複数形と所有格" tabindex="-1">複数形と所有格 <a class="header-anchor" href="#複数形と所有格" aria-hidden="true">#</a></h3><p>通常のリンクについては、文章になじみやすいように、角括弧の中に複数形や所有格を入れることができます。言い換えれば、<code>&lt;Object&gt;</code>sのような使いにくい構文を使用する必要はありません（それもサポートされています）。単純に<code>&lt;Objects&gt;</code>と書けば、シンボルObjectにうまくリンクしてくれます。複数形や所有格など、どのような形でも扱うことができます。冗談ではありません。Foxes, Fox&#39;s, Foxes&#39;, Children, Mice, Alumni, Indices, Amoebae, Teeth, などなど、とにかく試してみてください。</p><h2 id="追加ドキュメント" tabindex="-1">追加ドキュメント <a class="header-anchor" href="#追加ドキュメント" aria-hidden="true">#</a></h2><p>時にはコード要素に直接対応しないドキュメントを含めたいことがあります。例えば、ライセンス情報やアーキテクチャの注記を含めたい場合です。これには2つの方法があります。</p><h3 id="単体でのコメント" tabindex="-1">単体でのコメント <a class="header-anchor" href="#単体でのコメント" aria-hidden="true">#</a></h3><p>あなたが書くコメントのほとんどは、ソースコードの要素に直接対応するものですが、そうでなければならないというわけではありません。利用可能なキーワードのいずれかを選び、そのキーワードで独立したコメントを作成することができます。例えば:</p><div class="language-cpp"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* Class: Counter</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"> * A class that manages an incrementing counter.</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"> */</span></span>
<span class="line"><span style="color:#A6ACCD;">public </span><span style="color:#C792EA;">class</span><span style="color:#F07178;"> </span><span style="color:#FFCB6B;">Counter</span></span>
<span class="line"><span style="color:#F07178;">   </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>「タイトル」のように「キーワード: タイトル」の行で始めることを忘れてはいけません。上記の「License」のように「keyword: title」行で始めることを忘れてはなりません。これはNatural Docsが通常のテキストファイルと区別する方法です。</p><h2 id="リストの文書化" tabindex="-1">リストの文書化 <a class="header-anchor" href="#リストの文書化" aria-hidden="true">#</a></h2><p>もう一つ知っておくと便利なことがあります。例えば、定数のような小さなドキュメントをたくさん持っているとします。それぞれに個別のコメントを書くのは、いくら圧縮しても非常に面倒です。</p><div class="language-c"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// Constant: COUNTER_NORMAL</span></span>
...
<span class="line"></span></code></pre></div><p>CounterModeだけでなく、CounterMode.Oddへのリンクも可能になりました。</p>`,98),t=[e];function o(c,i,r,C,y,A){return a(),n("div",null,t)}const h=s(p,[["render",o]]);export{D as __pageData,h as default};
