import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.43c433ff.js";const u=JSON.parse('{"title":"ディレクトリ構造","description":"","frontmatter":{},"headers":[],"relativePath":"translation/honkit/structure.md","filePath":"translation/honkit/structure.md","lastUpdated":1676126774000}'),o={name:"translation/honkit/structure.md"},p=e(`<h1 id="ディレクトリ構造" tabindex="-1">ディレクトリ構造 <a class="header-anchor" href="#ディレクトリ構造" aria-label="Permalink to &quot;ディレクトリ構造&quot;">​</a></h1><p>HonKitはシンプルなディレクトリ構造を使用しています。<a href="./pages">SUMMARY</a>にリストされたすべてのMarkdown/AsciidocファイルはHTMLに変換されます。多言語の書籍は若干<a href="./languages">異なる構造</a>になっています。</p><p>基本的なHonKitは通常、次のようなものです。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">.</span></span>
...
<span class="line"><span style="color:#24292e;">bin/*</span></span></code></pre></div><h3 id="subdirectory" tabindex="-1">サブディレクトリを使ったプロジェクト統合 <a class="header-anchor" href="#subdirectory" aria-label="Permalink to &quot;サブディレクトリを使ったプロジェクト統合 {#subdirectory}&quot;">​</a></h3><p>ソフトウェアプロジェクトでは、プロジェクトのドキュメント用のブックを保存するためにサブディレクトリ（<code>docs/</code>など）を使用することができます。また、<a href="./config"><code>root</code> オプション</a>でHonKitがブックのファイルを見つけることができるフォルダを設定することができます。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">.</span></span>
<span class="line"><span style="color:#e1e4e8;">├── book.json</span></span>
