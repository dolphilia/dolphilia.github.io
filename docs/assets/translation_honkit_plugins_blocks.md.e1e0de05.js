import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.43c433ff.js";const h=JSON.parse('{"title":"ブロックの拡張","description":"","frontmatter":{},"headers":[],"relativePath":"translation/honkit/plugins/blocks.md","filePath":"translation/honkit/plugins/blocks.md","lastUpdated":1676126774000}'),p={name:"translation/honkit/plugins/blocks.md"},o=l(`<h1 id="ブロックの拡張" tabindex="-1">ブロックの拡張 <a class="header-anchor" href="#ブロックの拡張" aria-label="Permalink to &quot;ブロックの拡張&quot;">​</a></h1><p>テンプレートブロックを拡張することは、作者に追加機能を提供するための最良の方法です。</p><p>最も一般的な使用法は、実行時にいくつかのタグ内のコンテンツを処理することです。これは <a href="./filters">filters</a> のようなものですが、単一の式に制限されないので、ステロイドのようなものです。</p><h3 id="新規ブロックの定義" tabindex="-1">新規ブロックの定義 <a class="header-anchor" href="#新規ブロックの定義" aria-label="Permalink to &quot;新規ブロックの定義&quot;">​</a></h3><p>ブロックはプラグインによって定義され、ブロックはブロックディスクリプタに関連付けられた名前のマップである。ブロックディスクリプタは、少なくとも <code>process</code> メソッドを含む必要があります。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#79B8FF;">module</span><span style="color:#E1E4E8;">.</span><span style="color:#79B8FF;">exports</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="color:#24292E;">        }</span></span>
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">};</span></span></code></pre></div><p><code>process</code>は、タグを置き換えるhtmlコンテンツを返す必要があります。this\` と HonKit API については <a href="./api">Context and APIs</a> を参照してください。</p><h3 id="ブロック引数の扱い" tabindex="-1">ブロック引数の扱い <a class="header-anchor" href="#ブロック引数の扱い" aria-label="Permalink to &quot;ブロック引数の扱い&quot;">​</a></h3><p>ブロックに引数を渡すことができる。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">{% tag1 &quot;argument 1&quot;, &quot;argument 2&quot;, name=&quot;Test&quot; %}</span></span>
