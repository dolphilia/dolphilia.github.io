import{_ as s,c as n,o as a,Q as p}from"./chunks/framework.44f152d8.js";const d=JSON.parse('{"title":"入出力","description":"","frontmatter":{},"headers":[],"relativePath":"translation/hsp/i_stdio.md","lastUpdated":1676126774000}'),e={name:"translation/hsp/i_stdio.md"},l=p(`<h1 id="入出力" tabindex="-1">入出力 <a class="header-anchor" href="#入出力" aria-label="Permalink to &quot;入出力&quot;">​</a></h1><p><strong>対応</strong>:</p><ul><li>Win</li><li>Cli</li><li>Let</li></ul><h2 id="getkey" tabindex="-1">getkey <a class="header-anchor" href="#getkey" aria-label="Permalink to &quot;getkey {#getkey}&quot;">​</a></h2><p>キー入力チェック</p><p><strong>グループ</strong>:</p><p>基本入出力制御命令</p><p><strong>パラメーター</strong>:</p><pre><code>p1,p2
p1=変数   : 読み込むための変数
p2=1〜(1) : キーコード
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>この表に載っているキー以外でも、取得できる場合があります。(サンプルを実行するとキーコードを調べることができます。)</p><p><strong>例</strong>:</p><p>title &quot;キー入力してください(^^)v&quot; onkey *inkey onclick *inkey stop *inkey if lparam&gt;&gt;30:stop mes iparam stop</p><p><strong>参照</strong>:</p><p>stick</p><h2 id="mouse" tabindex="-1">mouse <a class="header-anchor" href="#mouse" aria-label="Permalink to &quot;mouse {#mouse}&quot;">​</a></h2><p>マウスカーソル座標設定</p><p><strong>グループ</strong>:</p><p>基本入出力制御命令</p><p><strong>パラメーター</strong>:</p><pre><code>p1,p2,p3
p1,p2 : 設定するX,Y座標
p3(0) : 設定モード値
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>実行ファイル作成時は、この命令は無効になります。</p><p><strong>参照</strong>:</p><p>logmes</p><p><strong>非対応</strong>:</p><ul><li>Let</li></ul><h2 id="mcall" tabindex="-1">mcall <a class="header-anchor" href="#mcall" aria-label="Permalink to &quot;mcall {#mcall}&quot;">​</a></h2><p>メソッドの呼び出し</p><p><strong>グループ</strong>:</p><p>基本入出力制御命令</p><p><strong>パラメーター</strong>:</p><pre><code>p1,p2,p3…
p1 : 変数名
p2 : メソッド名
p3 : パラメーター
