...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="color" tabindex="-1">color <a class="header-anchor" href="#color" aria-label="Permalink to &quot;color {#color}&quot;">​</a></h2><p>カラー設定</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="screen" tabindex="-1">screen <a class="header-anchor" href="#screen" aria-label="Permalink to &quot;screen {#screen}&quot;">​</a></h2><p>ウィンドウを初期化</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3,p4,p5,p6,p7,p8
 p1=0〜(0)  : ウィンドウID
 p2=1〜(640): 初期化する画面サイズX（1ドット単位）
 p3=1〜(480): 初期化する画面サイズY（1ドット単位）
 p4=0〜(0)  : 初期化する画面モード
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><strong>参照</strong>:</p><p>color palcolor hsvcolor</p><p><strong>追加対応</strong>:</p><ul><li>Let</li></ul><h2 id="hsvcolor" tabindex="-1">hsvcolor <a class="header-anchor" href="#hsvcolor" aria-label="Permalink to &quot;hsvcolor {#hsvcolor}&quot;">​</a></h2><p>HSV形式でカラーを設定する</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3
 p1=0〜191(0) : HSV形式 H値
 p2=0〜255(0) : HSV形式 S値
 p3=0〜255(0) : HSV形式 V値
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><strong>参照</strong>:</p><p>objinfo</p><p><strong>追加対応</strong>:</p><ul><li>Let</li></ul><p><strong>対応の補足</strong>:</p><p>HSPLet時、タイプ 19、画面のカラーモードは常に 0 を返します。 HSPLet時、タイプ 24、oncmd の割り込みウィンドウ ID はサポートされていません。 HSPLet時、タイプ 25はサポートされていません。</p><h2 id="grect" tabindex="-1">grect <a class="header-anchor" href="#grect" aria-label="Permalink to &quot;grect {#grect}&quot;">​</a></h2><p>回転する矩形で塗りつぶす</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,p2,p3,p4,p5,p6
 p1=0〜(0)   : 矩形の中心X座標
 p2=0〜(0)   : 矩形の中心Y座標
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>ウィンドウオブジェクト情報は、通常の使用では利用する必要はありません。 外部API(DLL)等にウィンドウオブジェクトのハンドル(HWND)を渡す場合など、特殊な用途に利用することができます。</p><p><strong>参照</strong>:</p><p>ginfo objinfo_bmscr objinfo_hwnd objinfo_mode</p><p><strong>追加対応</strong>:</p><ul><li>Let</li></ul><p><strong>対応の補足</strong>:</p><p>HSPLet時、ウィンドウハンドル（type==2）のみが利用可能です。</p><h2 id="axobj" tabindex="-1">axobj <a class="header-anchor" href="#axobj" aria-label="Permalink to &quot;axobj {#axobj}&quot;">​</a></h2><p>ActiveXコントロールの配置</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> p1,&quot;IID&quot;,p2,p3
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>単色で矩形を塗りつぶす場合は、boxf命令を使用してください。 また、四角形の頂点それぞれの色を指定したグラデーション描画を行なう場合は、gsquare命令を使用してください。</p><p><strong>参照</strong>:</p><p>boxf gsquare</p><h2 id="celload" tabindex="-1">celload <a class="header-anchor" href="#celload" aria-label="Permalink to &quot;celload {#celload}&quot;">​</a></h2><p>画像ファイルをバッファにロード</p><p><strong>グループ</strong>:</p><p>画面制御命令</p><p><strong>パラメーター</strong>:</p><pre><code> &quot;filename&quot;,p1,p2
 &quot;filename&quot; : ロードするファイル名
 p1=1〜(-1) : 読み込み先ウインドウID
 p2=0〜1(0) : 初期化する画面モード
