...
...
</code></pre><p>If no overrides are provided, malloc and free will be used.</p><h1 id="log-function-override" tabindex="-1">LOG FUNCTION OVERRIDE <a class="header-anchor" href="#log-function-override" aria-hidden="true">#</a></h1><p>You can override the log function at initialization time like this:</p><pre><code>void my_log(const char* message, void* user_data) {
    printf(&quot;sgl says: \\s\\n&quot;, message);
}
...
...
</code></pre><p>If no overrides are provided, puts will be used on most platforms. On Android, __android_log_write will be used instead.</p><h1 id="license" tabindex="-1">LICENSE <a class="header-anchor" href="#license" aria-hidden="true">#</a></h1><p>zlib/libpng license</p><p>Copyright (c) 2018 Andre Weissflog</p><p>This software is provided &#39;as-is&#39;, without any express or implied warranty. In no event will the authors be held liable for any damages arising from the use of this software.</p><p>Permission is granted to anyone to use this software for any purpose, including commercial applications, and to alter it and redistribute it freely, subject to the following restrictions:</p><pre><code>1. The origin of this software must not be misrepresented; you must not
...
distribution.
</code></pre>`,101),i=[r];function l(s,d,c,p,h,_){return n(),t("div",null,i)}const g=e(a,[["render",l]]);export{u as __pageData,g as default};
