import{_ as e,c as i,o as n,a as o}from"./app.b419af8d.js";const g=JSON.parse('{"title":"STEP BY STEP:","description":"","frontmatter":{},"headers":[],"relativePath":"translation/sokol/gfx_imgui.md","lastUpdated":1676126774000}'),t={name:"translation/sokol/gfx_imgui.md"},a=o(`<p>sokol_gfx_imgui.h -- debug-inspection UI for sokol_gfx.h using Dear ImGui</p><p>Project URL: <a href="https://github.com/floooh/sokol" target="_blank" rel="noreferrer">https://github.com/floooh/sokol</a></p><p>Do this: #define SOKOL_IMPL or #define SOKOL_GFX_IMGUI_IMPL</p><p>before you include this file in <em>one</em> C or C++ file to create the implementation.</p><p>NOTE that the implementation can be compiled either as C++ or as C. When compiled as C++, sokol_gfx_imgui.h will directly call into the Dear ImGui C++ API. When compiled as C, sokol_gfx_imgui.h will call cimgui.h functions instead.</p><p>Include the following file(s) before including sokol_gfx_imgui.h:</p><pre><code>sokol_gfx.h
...
</code></pre><p>If sokol_gfx_imgui.h is compiled as a DLL, define the following before including the declaration or implementation:</p><p>SOKOL_DLL</p><p>On Windows, SOKOL_DLL will define SOKOL_GFX_IMGUI_API_DECL as __declspec(dllexport) or __declspec(dllimport) as needed.</p><h1 id="step-by-step" tabindex="-1">STEP BY STEP: <a class="header-anchor" href="#step-by-step" aria-hidden="true">#</a></h1><p>--- create an sg_imgui_t struct (which must be preserved between frames) and initialize it with:</p><pre><code>    sg_imgui_init(&amp;sg_imgui, &amp;(sg_imgui_desc_t){ 0 });
...
...
</code></pre><p>This only affects memory allocation calls done by sokol_gfx_imgui.h itself though, not any allocations in OS libraries.</p><h1 id="license" tabindex="-1">LICENSE <a class="header-anchor" href="#license" aria-hidden="true">#</a></h1><p>zlib/libpng license</p><p>Copyright (c) 2018 Andre Weissflog</p><p>This software is provided &#39;as-is&#39;, without any express or implied warranty. In no event will the authors be held liable for any damages arising from the use of this software.</p><p>Permission is granted to anyone to use this software for any purpose, including commercial applications, and to alter it and redistribute it freely, subject to the following restrictions:</p><pre><code>1. The origin of this software must not be misrepresented; you must not
...
distribution.
</code></pre>`,45),s=[a];function r(u,l,d,_,m,p){return n(),i("div",null,s)}const h=e(t,[["render",r]]);export{g as __pageData,h as default};
